...
namespace App\Tests\Unit\Infrastructure\Persistence\Doctrine\EventListener;

use App\Infrastructure\Persistence\Doctrine\Attribute\SoftXorCheck;
use App\Infrastructure\Persistence\Doctrine\EventListener\SoftXorCheckListener;
...
final class SoftXorCheckListenerTest extends TestCase
{
    ...
    {
        $mapping = new OneToOneOwningSideMapping('dummy', DummyInvoice::class, DummyInvoice::class);
    ...
    {
        return new OneToOneInverseSideMapping('dummy', DummyInvoice::class, DummyInvoice::class);
    }
}
