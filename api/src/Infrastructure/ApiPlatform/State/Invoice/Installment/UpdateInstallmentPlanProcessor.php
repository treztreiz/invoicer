...
use App\Application\UseCase\Invoice\Installment\UpdateInstallmentPlanUseCase;

/**
 * @implements ProcessorInterface<InstallmentPlanInput, InvoiceOutput>
 */
final readonly class UpdateInstallmentPlanProcessor implements ProcessorInterface
{
    public function __construct(private UpdateInstallmentPlanUseCase $handler)
    {
    }
