 ...
 */
final class Version20251120032247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE installment (id UUID NOT NULL, installment_plan_id UUID NOT NULL, generated_invoice_id UUID DEFAULT NULL, integer INT NOT NULL, percentage NUMERIC(5, 2) NOT NULL, due_date DATE DEFAULT NULL, amount_net_value NUMERIC(12, 2) NOT NULL, amount_tax_value NUMERIC(12, 2) NOT NULL, amount_gross_value NUMERIC(12, 2) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE recurrence (id UUID NOT NULL, frequency VARCHAR(255) NOT NULL, interval SMALLINT NOT NULL, anchor_date DATE NOT NULL, end_strategy VARCHAR(255) NOT NULL, end_date DATE DEFAULT NULL, occurrence_count SMALLINT DEFAULT NULL, next_run_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN recurrence.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN recurrence.anchor_date IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN recurrence.end_date IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN recurrence.next_run_at IS \'(DC2Type:datetimetz_immutable)\'');
        ...
        $this->addSql('ALTER TABLE invoice ADD CONSTRAINT FK_906517442C414CE8 FOREIGN KEY (recurrence_id) REFERENCES recurrence (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        IF NOT EXISTS (
          ...
          WHERE c.conname = \'CHK_RECURRENCE_FREQUENCY\'
            AND r.relname = \'recurrence\'
            AND n.nspname = current_schema()
        ) THEN
          EXECUTE \'ALTER TABLE recurrence ADD CONSTRAINT "CHK_RECURRENCE_FREQUENCY" CHECK ("frequency" = ANY(ARRAY[\'\'MONTHLY\'\'::text, \'\'QUARTERLY\'\'::text]))\';
        END IF;
        END$$');
        $this->addSql('DO $$
        BEGIN
        IF NOT EXISTS (
          ...
          EXECUTE \'ALTER TABLE recurrence ADD CONSTRAINT "CHK_RECURRENCE_END_STRATEGY" CHECK ("end_strategy" = ANY(ARRAY[\'\'NEVER\'\'::text, \'\'UNTIL_DATE\'\'::text, \'\'UNTIL_COUNT\'\'::text]))\';
        END IF;
        END$$');
    }
